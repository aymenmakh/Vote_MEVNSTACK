            ...
            <div class="container">
                <div class="row section-heading-wrapper-alt">
                    ...
                    <div class="col-md-12 col-sm-12 text-center no-img-separator">
                        <h4>Cabinet Members</h4>
                        <span class="heading-separator heading-separator-horizontal"></span>
                        <h3 style="color:black" class="extra-large">Choose your better for </h3> <h2 style="color:red"><b>TUNISIA</b></h2>
               ...
               <div class="flas">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="team-layout-1 theme-custom-box-shadow theme-custom-box-animation">
                                ...
                                <figure class="team-member">
                                    <a  v-on:click="voteForCandidate('sebsi')" name="fb" value="big" title="ALEXANDER GARY">
                                      
                                        <img  v-bind:src="photo1" alt="ALEXANDER GARY"/>
                                    </a>
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <div class="team-layout-1 theme-custom-box-shadow theme-custom-box-animation">
                                ...
                                <figure class="team-member">
                                    <a v-on:click="voteForCandidate('marzouki')" title="MELISSA MUNOZ">
                                    
                                        <img v-bind:src="photo2" alt="MELISSA MUNOZ" />
                                    </a>
...
function populateCandidates() {
  //Voting.deployed().pushCandidates(['aymen','aymen2']);
 
  Voting.deployed().then(function(contractInstance) {
    contractInstance.allCandidates().then(function(candidateArray) {
      var myarray = candidateArray;
     // console.log(myarray);
      ...
      for (let i = 0; i < candidateArray.length; i++) {
         ...
         */
        candidates[provider.toUtf8(candidateArray[i])] = "candidate-" + i;
       // console.log(provider.toUtf8(candidateArray[i]));
      }
      setupCandidateRows();
...
console.log(cand)
  ...
  //break;
    ...
    Service.put({
      cin :  localStorage.getItem('connectedUser'),
      voted : true
      })
       this.$router.push({ name: "profil", params: { cin: localStorage.getItem('connectedUser') } });
    }
  },
  created: function() {
     this.$http
      ...
      .then(function(response) {
          this.c1 = response.data[0].c1;
          this.c2 = response.data[0].c2;
          this.photo1 = "http://localhost:3000/images/"+response.data[0].photo1;
          this.photo2 = "http://localhost:3000/images/"+response.data[0].photo2;
